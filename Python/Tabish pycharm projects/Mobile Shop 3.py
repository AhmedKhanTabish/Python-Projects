...
output_total_price = []
new_Mobile_Device_Discounted_Price = []
total_price = 0.00
...
def device_selection():
    ...
    if choice2 == 1:
        ...
        new_Mobile_Device_Discounted_Price.append(float(phones_price[0]))
        # break
    elif choice2 == 2:
        ...
        new_Mobile_Device_Discounted_Price.append(float(phones_price[1]))
        # break
    elif choice2 == 3:
        ...
        new_Mobile_Device_Discounted_Price.append(float(phones_price[2]))
        # break
    elif choice2 == 4:
        ...
        new_Mobile_Device_Discounted_Price.append(float(phones_price[3]))
        # break
    elif choice2 == 5:
        ...
        new_Mobile_Device_Discounted_Price.append(float(phones_price[4]))
        # break
    elif choice2 == 6:
        ...
        new_Mobile_Device_Discounted_Price.append(float(phones_price[5]))
        # break
    elif choice2 == 7:
        ...
        new_Mobile_Device_Discounted_Price.append(float(tablet_price[0]))
        # break
    elif choice2 == 8:
        ...
        new_Mobile_Device_Discounted_Price.append(float(tablet_price[1]))
        # break
    elif choice2 == 9:
        ...
        new_Mobile_Device_Discounted_Price.append(float(tablet_price[2]))
        # break
    elif choice2 == 10:
        ...
        new_Mobile_Device_Discounted_Price.append(float(tablet_price[3]))
        # break
    return choice2
...
def discount_offer():
    new_mobile_discount = float(sum(new_Mobile_Device_Discounted_Price * 0.1))
    return new_mobile_discount


# Step 10: New Price Calculation

def new_price_calculation():
    discounted_price = (output_total_price - new_Mobile_Device_Discounted_Price)
...
def printing_new_output(discounted_price):
    print(discounted_price)
    pass
